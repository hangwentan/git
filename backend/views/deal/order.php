														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	...
																	<p class="order-info"><a href="?r=deal/orderinfo">订单详情</a></p>
																	<p class="order-info"><a href="?r=deal/logistics">查看物流</a></p>
																</div>
															</li>
